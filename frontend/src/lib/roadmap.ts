...
export const ROADMAP_TOPICS: RoadmapTopicDef[] = [
  {
    ...
    relatedTags: ["array", "hashmap", "hashmap-frequency", "string", "matrix"],
    filterTag: "array",
    x: 680,
    y: 40,
  },
  ...
  },
  {
    ...
    prerequisites: ["trees"],
    next: ["graphs", "dp-1d"],
    relatedTags: ["backtracking"],
    filterTag: "backtracking",
    x: 680,
    y: 824,
  },
  {
    ...
    relatedTags: ["graphs-bfs-dfs", "graph"],
    filterTag: "graphs-bfs-dfs",
    x: 360,
    y: 1020,
  },
  {
  ...
  },
  {
    ...
    next: [],
    relatedTags: ["union-find"],
    filterTag: "union-find",
    x: 360,
    y: 1216,
  },
  {
